...
\end{tabularx}\par
\begin{itemize}
    \item GPA：4.2/4.3 \qquad 排名：\textbf{1}/99 \qquad 雅思：7.5
    \item 部分课程（百分制）：计算机组成与设计（100）、机器学习（98）、操作系统（98）、编译原理（97）、数学分析（H）（96）、线性代数（H）（96）
\end{itemize}
...
\publication
    ...
    {arXiv, 2026 \quad \textbf{ICLR 在投} \quad \href{https://arxiv.org/abs/2607.23263}{[arXiv]}\enspace\href{https://github.com/ZJUSCL/SeekJudge}{[代码]}}
